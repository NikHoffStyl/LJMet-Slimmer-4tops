...
public :
   ...
   vector<double>  theJetEta_JetSubCalc_BtagOrdered;
   vector<double>  theJetPhi_JetSubCalc_BtagOrdered;
   vector<double>  theJetEnergy_JetSubCalc_BtagOrdered;
   vector<double>  AK4JetDeepCSVb_MultiLepCalc_BtagOrdered;
   vector<double>  AK4JetDeepCSVbb_MultiLepCalc_BtagOrdered;
