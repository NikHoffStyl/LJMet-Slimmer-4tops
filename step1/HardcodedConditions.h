...
private:
    ...
    pair<double,double> GetMcTRFvpt2pb2016(double pt, int njets);
    pair<double,double> GetMcTRFvpt2pb2017(double pt, int njets);
    pair<double,double> GetMcTRFvpt2pb2018(double pt, int njets);
    pair<double,double> GetDataTRFvpt2pb2016(double pt, int njets);
    pair<double,double> GetDataTRFvpt2pb2017(double pt, int njets);
    pair<double,double> GetDataTRFvpt2pb2018(double pt, int njets);
    pair<double,double> GetMcTRFveta2pb2016(double eta, int njets);
    pair<double,double> GetMcTRFveta2pb2017(double eta, int njets);
    pair<double,double> GetMcTRFveta2pb2018(double eta, int njets);
    pair<double,double> GetDataTRFveta2pb2016(double eta, int njets);
    pair<double,double> GetDataTRFveta2pb2017(double eta, int njets);
    pair<double,double> GetDataTRFveta2pb2018(double eta, int njets);
    pair<double,double> GetMcTRFvmdr2pb2016(double mdr, int njets);
    pair<double,double> GetMcTRFvmdr2pb2017(double mdr, int njets);
    pair<double,double> GetMcTRFvmdr2pb2018(double mdr, int njets);
    pair<double,double> GetDataTRFvmdr2pb2016(double mdr, int njets);
    pair<double,double> GetDataTRFvmdr2pb2017(double mdr, int njets);
    pair<double,double> GetDataTRFvmdr2pb2018(double mdr, int njets);

    pair<double,double> GetMcTRFvpt3pb2016(double pt, int njets);
    pair<double,double> GetMcTRFvpt3pb2017(double pt, int njets);
    pair<double,double> GetMcTRFvpt3pb2018(double pt, int njets);
    pair<double,double> GetDataTRFvpt3pb2016(double pt, int njets);
    pair<double,double> GetDataTRFvpt3pb2017(double pt, int njets);
    pair<double,double> GetDataTRFvpt3pb2018(double pt, int njets);
    pair<double,double> GetMcTRFveta3pb2016(double eta, int njets);
    pair<double,double> GetMcTRFveta3pb2017(double eta, int njets);
    pair<double,double> GetMcTRFveta3pb2018(double eta, int njets);
    pair<double,double> GetDataTRFveta3pb2016(double eta, int njets);
    pair<double,double> GetDataTRFveta3pb2017(double eta, int njets);
    pair<double,double> GetDataTRFveta3pb2018(double eta, int njets);
    pair<double,double> GetMcTRFvmdr3pb2016(double mdr, int njets);
    pair<double,double> GetMcTRFvmdr3pb2017(double mdr, int njets);
    pair<double,double> GetMcTRFvmdr3pb2018(double mdr, int njets);
